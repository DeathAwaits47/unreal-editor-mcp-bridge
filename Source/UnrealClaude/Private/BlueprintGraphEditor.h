 ...
 * - Functions: CallFunction, PrintString, DynamicCast
...
public:
	 ...
	 * - "DynamicCast" - params: { target_class }
	 * - "Branch" / "IfThenElse"
...
private:
	...
	static UEdGraphNode* CreateDynamicCastNode(UEdGraph* Graph, const FString& TargetClass, int32 PosX, int32 PosY, FString& OutError);
	...
	static UEdGraphNode* CreateVariableGetNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& VariableName, const FString& ExternalParentClassPath, int32 PosX, int32 PosY, FString& OutError);
	static UEdGraphNode* CreateVariableSetNode(UEdGraph* Graph, UBlueprint* Blueprint, const FString& VariableName, const FString& ExternalParentClassPath, int32 PosX, int32 PosY, FString& OutError);
